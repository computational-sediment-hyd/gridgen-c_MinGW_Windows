# gridgen-c_MinGW_Windows

[gridgen-c](https://github.com/sakov/gridgen-c) is very useful as a two-dimensional orthogonal curvilinear grid generation library, but the [original](https://github.com/sakov/gridgen-c) only supports building on Mac or Linux and cannot be built on Windows as-is.
Therefore, I am publishing a modified version that can be built on Windows using MinGW.
